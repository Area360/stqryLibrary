...
package nz.co.stqry.library.volley.utils;
...
public class BitmapCache implements ImageLoader.ImageCache {
    ...
    /**
     * Find and return an existing BitmapCache stored in a {@link nz.co.stqry.library.volley.utils.BitmapCache.RetainFragment}, if not found a
     * new one is created using the supplied params and saved to a {@link nz.co.stqry.library.volley.utils.BitmapCache.RetainFragment}.
     *
